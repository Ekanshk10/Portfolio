...
Files: avatar.glb [1.05MB] > C:\Users\kanot\Desktop\Portfolio\frontend\public\models\avatar-transformed.glb [467.99KB] (56%)
*/
...
export function HeroBoy(props) {
  ...
  const group = useRef();
  const mouse = useRef(new THREE.Vector2()); // mouse variable can store x and y corrdinates
  ...
  useGSAP(() => {
    ...
    if (isIntroAnimation) {
      const handleMouseMove = (event) => {
        const { inneWidth, innerHeight } = window;

        // we normalised the mouse range form pixel to one so which Three js can understand
